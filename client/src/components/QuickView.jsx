        ...
        <div className="grid md:grid-cols-2 gap-6 p-6">
          ...
          <div className="flex flex-col space-y-4">
            ...
            <div className="flex gap-3 mt-4">
              <button className="flex items-center gap-2 flex-1 justify-center py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-lg shadow-md transition border border-black dark:border-white">
                <ShoppingCart className="h-5 w-5" />
                Add to Cart
              </button>
              <button className="p-3 rounded-lg border border-black dark:border-white hover:bg-red-50 dark:hover:bg-red-900/20 transition">
