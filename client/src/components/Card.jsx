        ...
        <div className="relative w-full h-full">
          ...
          {userRole === "buyer" && isAvailable && stock > 0 && (
            <div className="absolute top-3 right-3 z-[60]">
              <button
                ...
                className={`p-2.5 rounded-full shadow-md backdrop-blur-sm transition-all duration-300 cursor-pointer transform hover:scale-110 ${isWishlisted
          ...
          >
            <button
              ...
              className={`bg-white dark:bg-neutral-900 cursor-pointer text-gray-800 dark:text-gray-200 px-5 py-2.5 rounded-full shadow-lg hover:bg-gray-50 dark:hover:bg-neutral-800 transition-all duration-300 font-medium text-sm flex items-center gap-2 transform border border-black dark:border-white ${isHovered ? "translate-y-0" : "translate-y-5"
                }`}
            >
              <Eye size={16} />
              Quick View
