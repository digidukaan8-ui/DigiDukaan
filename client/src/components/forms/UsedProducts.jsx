        ...
        >
          ...
          <form onSubmit={handleSubmit(onFormSubmit)} className="space-y-5">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div>
                <label htmlFor="condition" className="block mb-1.5 font-medium text-sm text-gray-700 dark:text-gray-300">
                  Condition
                </label>
                <select
                  id="condition"
            ...
            {watchedDeliveryType !== "pickup" && (
              <div className="pt-2">
                <h4 className="mb-3 font-semibold text-base text-gray-900 dark:text-gray-200">Shipping Locations</h4>
                ...
                >
                  <FiPlus size={16} /> Add Shipping Location
                </button>
              </div>
            )}
