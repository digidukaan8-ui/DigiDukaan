...
import { handleAddProduct, hadnleUpdateProduct } from '../middlewares/product.middleware.js';
...
sellerRouter.patch('/products/:productId', authMiddleware('seller'), uploadProductMedia, validateFileSizes, hadnleUpdateProduct, updateProduct);
