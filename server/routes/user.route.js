...
import { getProducts, getProductByCategory, getProductById, searchProducts, getProductReviews } from '../controllers/product.controller.js';
...
userRouter.get('/products/reviews/:productId', getProductReviews);
